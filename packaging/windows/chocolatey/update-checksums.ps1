...
try {
    # Fetch checksums
    $loomChecksum = (Invoke-WebRequest -Uri $loomChecksumUrl -UseBasicParsing).Content.Trim()
    $loomsChecksum = (Invoke-WebRequest -Uri $loomsChecksumUrl -UseBasicParsing).Content.Trim()
